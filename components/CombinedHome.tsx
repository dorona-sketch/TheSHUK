    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 pb-12 animate-fade-in-up">
      <div className="grid grid-cols-2 gap-4 md:gap-6">
        <button
          ...
          className="relative overflow-hidden rounded-2xl border border-cyan-700/70 bg-gradient-to-br from-cyan-700/25 to-slate-900 p-4 text-left min-h-[104px] md:min-h-[128px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-shuk-primary active:scale-[0.99] transition-transform"
        >
        ...
        <button
          ...
          className="relative overflow-hidden rounded-2xl border border-fuchsia-700/70 bg-gradient-to-br from-fuchsia-700/25 to-slate-900 p-4 text-left min-h-[104px] md:min-h-[128px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-shuk-primary active:scale-[0.99] transition-transform"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <section className="flex flex-col h-full">
          <div className="flex justify-between items-center mb-4 px-1 border-b border-shuk-border pb-2">
            ...
            <button type="button" onClick={() => onSelectMode('BREAKS')} className="min-h-[40px] px-2 text-xs font-bold text-shuk-muted hover:text-white uppercase tracking-wider">View All</button>
          </div>
        ...
        <section className="flex flex-col h-full">
          <div className="flex justify-between items-center mb-4 px-1 border-b border-shuk-border pb-2">
            ...
            <button type="button" onClick={() => onSelectMode('MARKET')} className="min-h-[40px] px-2 text-xs font-bold text-shuk-muted hover:text-white uppercase tracking-wider">View All</button>
          </div>
          ...
          {sales.length > 0 ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center border-2 border-dashed border-shuk-border rounded-xl bg-shuk-surface/50 min-h-[200px]">
              <p className="text-shuk-silver font-medium text-sm">No sales closing soon.</p>
            </div>
          )}
        </section>
      </div>
