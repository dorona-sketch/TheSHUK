          ...
          <div className="flex items-center gap-1.5 sm:gap-3 md:gap-4">
            ...
            {currentUser ? (
              <>
                {currentUser.role === 'SELLER' && (
                  <button
                    ...
                    className="hidden md:flex items-center text-sm font-bold text-shuk-silver hover:text-white bg-shuk-surfaceHigh hover:bg-shuk-border px-3 py-1.5 rounded-full border border-shuk-border transition-colors"
                  >
                    Dashboard
                  </button>
                )}
                ...
                <div className="relative" ref={notifRef}>
                  ...
                  >
                    ...
                    {unreadNotifs > 0 && <span className="absolute top-1 right-1 inline-flex items-center justify-center w-2.5 h-2.5 bg-red-500 rounded-full ring-2 ring-shuk-dark"></span>}
                  </button>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <button onClick={() => onNavigate('LOGIN')} className="text-shuk-muted hover:text-shuk-silver font-medium text-xs sm:text-sm px-1">Sign In</button>
                <button onClick={() => onNavigate('REGISTER')} className="bg-shuk-primary text-shuk-dark px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-md font-bold text-xs sm:text-sm">Join</button>
              </div>
            )}
          </div>
        </div>
